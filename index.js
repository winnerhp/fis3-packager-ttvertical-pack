// packager: fis.plugin(_ttpack, {
//     '/page/index/index.js': [
//         '/page/index/index.js',
//         '/page/index/index.js:deps',
//         '/page/index/index.js:asyncs'
//     ]
// })
/**
 * 打包阶段插件接口
...
module.exports = function(ret, pack, settings, opt) { 
  ...
  var ns = fis.config.get('namespace');  // undefined

  var connector = fis.config.get('namespaceConnector', ':'); // :
  var root = fis.project.getProjectPath(); // " /Users/hp/Documents/repos/vertical_channel/finance_channel"
  ...
  Object.keys(pack).forEach(function(subpath, index) {
    ...
    // ns namespace   connector :
    var pid = (ns ? ns + connector : '') + 'p' + index;// p0

    var complete = path.join(root, subpath) // 合并路径

    var pkg = fis.file.wrap(complete);
